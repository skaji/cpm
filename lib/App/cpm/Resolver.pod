...
and want to fetching distributions via:
...
=item App::cpm::Resolver::MetaDB

=item App::cpm::Resolver::MetaCPAN

=item App::cpm::Resolver::Mirror

=item App::cpm::Resolver::Snapshot

=item App::cpm::Resolver::Cascade
