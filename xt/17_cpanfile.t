...
with_same_local {
    ...
    like $r->err, qr{DONE install App-ChangeShebang-0.05 \(https://github.com/skaji/change-shebang\@0\.05\)};
    ...
    is $r->exit, 0;
    like $r->err, qr/DONE install App::ChangeShebang, you already have 0\.05/;
